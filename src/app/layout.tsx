...
import './globals.css';
import Background from '../common/ui/background/page';

const inter = Inter({ subsets: ['latin'] });

export const metadata: Metadata = {
  title: 'Son Nguyen - Portfolio',
  description:
    'Full Stack Developer passionate about creating beautiful, interactive web experiences, interactions and high-performance.',
  icons: {
    icon: {
